...
Or from anywhere you will run
	$0 prework /downloads/free-artist-discography
...
From /downloading/free-artist-discography you run
	$0 postwork ./ /my-music/free-artist
	$0 postwork ./ /public/free-artist
Or from anywhere you run
	$0 postwork /downloading/free-artist-discography /my-music/free-artist
	$0 postwork /downloading/free-artist-discography /public/free-artist
...
/my-music directory, you would not want to use
	...
	$0 /downloading/free-artist-discography /my-music
...
postwork() {
	...
	| while read FILE; do
		...
		if [[ -n "$SEEDFILE" ]]; then
			...
			echo "$SEEDFILE now points to $MOVEDFILE"
